...
LCD_DAT   EQU   PTS     ;LCD data port S, pins PS4, PS5, PS6, PS7
LCD_CNTR  EQU   PORTE   ;LCD control for port E, pins PE7(RS), PE4(E)
LCD_E     EQU   $10     ;Enable signal for the LCD, pin PE4
LCD_RS    EQU   $80     ;Reset signal for the LCD  , pin PE7
...
MainLoop      JSR     clrLCD      ;clear LCD & home cursor
              ...
              LDAA    $3000       ;load contents at $3000 into register A
              JSR     leftHLF     ;convert the left half of A into ASCII
              STAA    MEM1        ;store ASCII byte into mem1
              
              LDAA    $3000       ;load contents at $3000 into register A
              JSR     rightHLF    ;convert the right half of A into ACSII
              STAA    MEM2        ;store the ASCII byte into mem2

              LDAA    $3001       ;load contents at $3001 into register A
              JSR     leftHLF     ;convert the left half of A into ASCII
...
;subroutine section
;this is where we actually make the subroutines for all of those JSR commands
